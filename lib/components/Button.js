...
var renderButtonIcon = function renderButtonIcon(_ref) {
  var icon = _ref.icon,
  ...
  if (icon) {
    if (typeof icon === 'string') {
      ...
      iconElement = _react2.default.cloneElement(icon, { className: iconClassNames });
    }
  }
  return iconElement;
};
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['color', 'size', 'children', 'content', 'onClick', 'icon', 'iconPosition']);
      ...
      return _react2.default.createElement(
        'button',
        _extends({ className: buttonClassNames, onClick: onClick }, rest),
        renderButtonIcon({ icon: icon, iconPosition: iconPosition }),
