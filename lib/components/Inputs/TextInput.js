  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          value = _props.value,
          type = _props.type,
          rest = _objectWithoutProperties(_props, ['className', 'errorText', 'tooltip', 'name', 'label', 'onChange', 'isNumericOnly', 'hasFocus', 'placeholder', 'value', 'type']);

      var showPlaceholder = hasFocus && !value ? placeholder : null;

      var inputContainerClassName = (0, _classnames2.default)({
      ...
      return _react2.default.createElement(
        ...
        type !== 'hidden' && _react2.default.createElement(_InputLabel2.default, {
