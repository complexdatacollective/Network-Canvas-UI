...
var RadioInput = function (_Component) {
  ...
  function RadioInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RadioInput.__proto__ || Object.getPrototypeOf(RadioInput)).call.apply(_ref, [this].concat(args))), _this), _this.handleBlur = function (e) {
  ...
  _createClass(RadioInput, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          value = _props.value,
          rest = _objectWithoutProperties(_props, ['checked', 'className', 'errorText', 'name', 'label', 'onChange', 'value']);
