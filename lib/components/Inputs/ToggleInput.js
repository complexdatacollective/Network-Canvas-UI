  ...
  _createClass(ToggleInput, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          value = _props.value,
          rest = _objectWithoutProperties(_props, ['checked', 'className', 'containerClassName', 'color', 'errorText', 'inline', 'tooltip', 'name', 'label', 'onCheck', 'isChecked', 'value']);

      var toggleButtonClassName = (0, _classnames2.default)(_defineProperty({
        toggle__button: true
      }, 'toggle__button--' + color, !!color));

      var toggleContainerClassName = (0, _classnames2.default)({
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_InputLabel2.default, { name: name, label: label, errorText: errorText, tooltip: tooltip }),
        _react2.default.createElement('input', _extends({
          className: (0, _classnames2.default)(['toggle', className]),
          name: name,
          type: 'checkbox',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: toggleButtonClassName })
        )
      );
    }
  }]);
