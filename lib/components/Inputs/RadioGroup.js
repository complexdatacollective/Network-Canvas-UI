  ...
  _createClass(RadioGroup, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'errorText', 'tooltip', 'name', 'label', 'onRadioClick', 'options', 'value', 'inline']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: inline ? 'grid__container grid--x-bookend' : 'grid__stack' },
