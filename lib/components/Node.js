...
var _scaleTextToFit = require('../utils/scaleTextToFit');

var _scaleTextToFit2 = _interopRequireDefault(_scaleTextToFit);
...
var Node = function (_Component) {
  ...
  _createClass(Node, [{
    ...
    value: function componentDidMount() {
      (0, _scaleTextToFit2.default)(this.labelText, { unit: 'em', increment: 0.0625 });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'node__label-text', ref: function ref(labelText) {
